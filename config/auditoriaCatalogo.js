...
const REGLAS = [
    ...
    { patron: /^\/admin\/kardex/, entidad: 'Kardex', modulo: 'Reportes',
      ...
      severidad: SEVERIDADES.AVISO },
    { patron: /^\/admin\/reportes\/(margen-platillos|salud-inventario|explosion-recetas|ventas-mesero|consumo-insumos|ventas-horas|tendencias|ventas-turno)\/exportar/,
      entidad: 'Reportes', modulo: 'Reportes',
      accion: 'Exportar reporte a CSV', categoria: CATEGORIAS.EXPORTACION,
      severidad: SEVERIDADES.AVISO },
    // Reportes creados después del catálogo: se registran con el mismo
    // criterio (lectura sensible con aviso) para que el cuadre sea completo.
    { patron: /^\/admin\/reportes\/tendencias/, entidad: 'Tendencias de venta', modulo: 'Reportes',
      accion: 'Consultar tendencias de venta', categoria: CATEGORIAS.LECTURA,
      severidad: SEVERIDADES.AVISO },
    { patron: /^\/admin\/reportes\/ventas-turno/, entidad: 'Ventas y consumo del turno', modulo: 'Reportes',
      accion: 'Consultar ventas y consumo del turno', categoria: CATEGORIAS.LECTURA,
      severidad: SEVERIDADES.AVISO },
    { patron: /^\/admin\/pedidos\/exportar/, entidad: 'Ventas / Pedidos', modulo: 'Reportes',
      accion: 'Exportar ventas y pedidos del período a CSV', categoria: CATEGORIAS.EXPORTACION,
      severidad: SEVERIDADES.AVISO },
    { patron: /^\/admin\/pedidos/, entidad: 'Ventas / Pedidos', modulo: 'Reportes',
      accion: 'Consultar ventas y pedidos del período', categoria: CATEGORIAS.LECTURA,
      severidad: SEVERIDADES.AVISO },
